...
public ref struct SpanTokenizer2<T>
    where T : IEquatable<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SpanTokenizer2{T}"/> struct.
    /// </summary>
    ...
    public SpanTokenizer2(Span<T> span, T separator0, T separator1)
    {
        this.span = span;
    ...
    /// </summary>
    /// <returns>An <see cref="SpanTokenizer2{T}"/> instance targeting the current <see cref="Span{T}"/> value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly SpanTokenizer2<T> GetEnumerator() => this;
    ...
    public bool MoveNext()
    {
        ...
        if (newEnd <= length)
        {
            ...
            int index = this.span.Slice(newEnd).IndexOfAny(this.separator0, this.separator1);
